...
Webflow.require('ix').init([
  {"slug":"clic-1","name":"Clic 1","value":{"style":{"opacity":1},"triggers":[{"type":"click","selector":".explication","loopA":true,"stepsA":[{"opacity":1,"transition":"opacity 100ms ease-in 0ms"}],"stepsB":[{"opacity":0,"transition":"opacity 100ms ease-in 0ms"}]}]}},
  {"slug":"clic-2-1","name":"Clic 2 - 1","value":{"style":{"opacity":0.52},"triggers":[{"type":"click","stepsA":[],"stepsB":[]}]}},
  {"slug":"texte-bleu","name":"texte bleu","value":{"style":{},"triggers":[{"type":"click","selector":".texte","stepsA":[{"transition":"transform 200ms ease-in 0ms","x":"600px","y":"0px"}],"stepsB":[{"transition":"transform 200ms ease-in 0ms","x":"0px","y":"0px"}]}]}}
]);
